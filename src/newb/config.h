...
#define NL_CONTRAST 0.95             // 0.3 low ~ 2.0 high
...
/* Terrain lighting */
#define NL_SUN_INTENSITY 4.7    // 0.5 weak ~ 5.0 bright
#define NL_TORCH_INTENSITY 1.35  // 0.5 weak ~ 3.0 bright
...
#define NL_MORNING_SUN_COL vec3(0.95,0.55,0.0)
#define NL_NOON_SUN_COL    vec3(0.97,0.86,0.67)
#define NL_NIGHT_SUN_COL   vec3(0.05,0.05,0.05)

/* Ambient light on terrain (light that is added everywhere) */
#define NL_NETHER_AMBIENT vec3(3.0,2.16,1.89)
#define NL_END_AMBIENT    vec3(0.2,0.2,0.2)
...
#define NL_MIST_DENSITY 0.66      // 0.0 no mist ~ 1.0 misty
#define NL_RAIN_MIST_OPACITY 0.5 // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.086,0.37,0.95)*1.1
#define NL_DAY_HORIZON_COL   vec3(0.38,0.78,0.96)*3.2
#define NL_NIGHT_ZENITH_COL  vec3(0.017,0.03,0.066)
#define NL_NIGHT_HORIZON_COL vec3(0.125,0.2,0.31)
...
#define NL_END_HORIZON_COL   vec3(0.443,0.082,0.957)
#define NL_DAWN_ZENITH_COL   vec3(0.086,0.37,0.95)
#define NL_DAWN_HORIZON_COL  vec3(0.9,0.5,0.0)*1.8
#define NL_DAWN_EDGE_COL     vec3(1.0,0.75,0.0)*1.8
...
#define NL_LANTERN_WAVE 0.19   // [toggle] 0.05 subtle ~ 0.4 large swing
...
#define NL_WATER_TINT vec3(0.24,0.56,2.0)
...
#define NL_UNDERWATER_TINT vec3(0.54,0.23,2.3) // fog tint color when underwater

/* Cloud type */
#define NL_CLOUD_TYPE 2 // 0:vanilla, 1:soft, 2:rounded

/* Vanilla cloud settings - make sure to remove clouds.png when using this */
#define NL_CLOUD0_THICKNESS 1.1      // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_RAIN_THICKNESS 1.1 // 0.5 slim ~ 8.0 fat
...
#define NL_CLOUD2_RAIN_THICKNESS 2.35 // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_STEPS 7            // 3 low quality ~ 16 high quality
#define NL_CLOUD2_SCALE 0.042        // 0.003 large ~ 0.3 tiny
...
#define NL_AURORA_VELOCITY 0.13 // 0.0 static ~ 0.3 very fast
#define NL_AURORA_SCALE 0.12    // 0.002 large ~ 0.4 tiny
#define NL_AURORA_WIDTH 0.18    // 0.04 thin line ~ 0.4 thick lines
#define NL_AURORA_COL1 vec3(0.15,1.0,1.0)*3.0
#define NL_AURORA_COL2 vec3(0.0,0.0,0.45)*2.3
...
#define NL_SUNMOON_SIZE 1.35     // 0.3 tiny ~ 4.0 massive
